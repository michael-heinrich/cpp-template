...
${BIN_DIR}/${BINARY_NAME}: ${SUBPROJECT_BINARY} .compile-sources
	${MKDIR} -p ${BIN_DIR}
	@echo $(PWD)
	${LINK.cc} -o ${BIN_DIR}/${BINARY_NAME} ${OBJECT_FILES} ${SUBPROJECT_BINARY} ${LDLIBSOPTIONS} ${PROFILE_LINKER} ${LINK_OPTIMIZATION}
...
${BIN_DIR}/${TEST_BINARY_NAME}: ${SUBPROJECT_BINARY} .compile-sources .compile-tests
	${MKDIR} -p ${BIN_DIR}
	@echo $(PWD)
	${LINK.cc} -o ${BIN_DIR}/${TEST_BINARY_NAME} ${OBJECT_FILES} ${TEST_OBJECT_FILES} ${SUBPROJECT_BINARY} ${GTEST_LINKER_OPTIONS} ${LDLIBSOPTIONS} ${PROFILE_LINKER} ${LINK_OPTIMIZATION}
